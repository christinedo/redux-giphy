...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    fetchSearchGiphys: function fetchSearchGiphys(searchTerms) {
      return dispatch(Object(_actions_giphy_actions__WEBPACK_IMPORTED_MODULE_2__["fetchSearchGiphys"])(searchTerms));
    }
  };
};

var GiphysSearchContainer = Object(react_redux__WEBPACK_IMPORTED_MODULE_0__["connect"])(mapStateToProps, mapDispatchToProps)(_giphys_search__WEBPACK_IMPORTED_MODULE_1__["default"]);
/* harmony default export */ __webpack_exports__["default"] = (GiphysSearchContainer);
...
var fetchSearchGiphys = function fetchSearchGiphys(searchTerm) {
  return $.ajax({
    url: "http://api.giphy.com/v1/gifs/search?q=".concat(searchTerm, "&api_key=").concat("JwzWvTCsiCiV3nE1h9C7ULsuZLRri19d", "&limit=2")
  });
};
